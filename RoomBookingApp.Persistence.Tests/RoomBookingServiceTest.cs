...
namespace RoomBookingApp.Persistence.Tests
{
    public class RoomBookingServiceTest
    {
        ...
        public void Should_Return_Available_Rooms()
        {
            ...
            context.Add(new RoomBooking { RoomId = 1, Date = date.Date, Email="sample@email.com", FullName="Sample Name" });
            context.Add(new RoomBooking { RoomId = 2, Date = date.AddDays(-1), Email="sample1@email.com", FullName="Sample Name1" });
        ...
        public void Should_Save_Room_Booking()
        {
            ...
            var roomBooking = new RoomBooking { RoomId = 1, Date = new DateTime(2021, 06, 09), FullName = "Sample Name", Email = "Sample@email.com" };
